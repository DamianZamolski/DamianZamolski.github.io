      ...
      ;(function (t) {
        !(function () {
              ...
              iu = function () {
                var t =
                    arguments.length < 1 || void 0 === arguments[0]
                      ...
                      : String(arguments[0]),
                  e =
                    this instanceof iu ? new nu(t) : void 0 === t ? nu() : nu(t)
                return '' === t && (ou[e] = !0), e
              }
            Et(iu, nu)
          ...
          var Ac =
              ...
              (void 0 !== Ac && Ac),
            Ic = 'URLSearchParams' in Ac,
            _c = 'Symbol' in Ac && 'iterator' in Symbol,
            jc =
              'FileReader' in Ac &&
              'Blob' in Ac &&
              (function () {
                ...
                ;(this.bodyUsed = this.bodyUsed),
                  ...
                  t
                    ? 'string' == typeof t
                      ...
                      : Ic && URLSearchParams.prototype.isPrototypeOf(t)
                      ...
                      : Nc && (ArrayBuffer.prototype.isPrototypeOf(t) || Uc(t))
          ...
          var Kc = ['DELETE', 'GET', 'HEAD', 'OPTIONS', 'POST', 'PUT']
          function Vc(t, e) {
          ...
          ;(Vc.prototype.clone = function () {
            return new Vc(this, { body: this._bodyInit })
          }),
            Gc.call(Vc.prototype),
            Gc.call(qc.prototype),
            (qc.prototype.clone = function () {
              return new qc(this._bodyInit, {
                status: this.status,
            ...
            (qc.error = function () {
              var t = new qc(null, { status: 0, statusText: '' })
              return (t.type = 'error'), t
            })
          var Hc = [301, 302, 303, 307, 308]
          qc.redirect = function (t, e) {
            if (-1 === Hc.indexOf(e))
              throw new RangeError('Invalid status code')
            return new qc(null, { status: e, headers: { location: t } })
          }
          var Xc = Ac.DOMException
          try {
            new Xc()
          } catch (e) {
            ;((Xc = function (t, e) {
          ...
          function Yc(t, e) {
            return new Promise(function (r, n) {
              ...
              if (o.signal && o.signal.aborted)
                return n(new Xc('Aborted', 'AbortError'))
          ...
          var es = (function () {
            ...
            ? Object.assign
            : function (t, e) {
                for (var r, n, o = ts(t), i = 1; i < arguments.length; i++) {
...
//# sourceMappingURL=polyfill-dc3d4b3368c39956ad77.js.map
