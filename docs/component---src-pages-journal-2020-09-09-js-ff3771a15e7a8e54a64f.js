  ...
  [11],
  {
    '8VgL': function (e, t, a) {
      ...
      var n = a('q1tI'),
        ...
        f = E('Bananas', 1.09, 0.33, 22.84),
        p = E('Chickpeas', 6.2, 2.2, 14),
        v = (E('Eggs', 12.56, 9.51, 0.72), E('Hazelnuts', 14.95, 60.75, 16.7)),
        h = E('Kerrygold Butter', 0.7, 82.5, 0.7),
        b = E('KFD WPC', 78, 7, 5),
        y = E('MCT Oil', 0, 100, 0),
        g = E('Oats', 13.15, 6.52, 67.7)
      t.default = function () {
        return r.a.createElement(
          l.a,
          { title: '2020-09-03' },
...
//# sourceMappingURL=component---src-pages-journal-2020-09-09-js-ff3771a15e7a8e54a64f.js.map
