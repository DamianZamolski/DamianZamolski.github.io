_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [3],
  {
    ...
    IKlv: function (e, t, n) {
      ...
      var q = (0, T.getURL)()
      ;(0, P.hasBasePath)(q) && (q = (0, P.delBasePath)(q))
      var H = new R.default(F, O, I),
        U = function (e) {
          var t = f(e, 2),
            n = t[0],
            r = t[1]
                    ...
                    Y.isSsr &&
                      ...
                      Y.replace(
                        Y.pathname +
                          ...
                          String(
                            v.assign(
                              v.urlQueryToSearchParams(Y.query),
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 29:
                      return (
                        (t.router = Y = (0, h.createRouter)(I, D, q, {
                          initialProps: N,
                          pageLoader: H,
                          App: J,
                          Component: G,
                        ...
                        ee({ App: J, Component: G, props: N, err: u }),
                        e.abrupt('return', Q)
                      )
                    case 35:
                      e.next = 37
      ...
      function ne(e) {
        ...
        return (
          console.error(n),
          H.loadPage('/_error').then(function (r) {
            var a = r.page,
              o = ce(t),
              i = {
                Component: a,
                AppTree: o,
                router: Y,
                ctx: { err: n, pathname: I, query: D, asPath: q, AppTree: o },
              }
      ...
      function ue(e) {
        ...
        return g.default.createElement(
          ...
          g.default.createElement(
            ...
            { value: (0, h.makePublicRouterInstance)(Y) },
            g.default.createElement(
