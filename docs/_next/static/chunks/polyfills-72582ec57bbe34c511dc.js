    ...
    Ri3X: function (t, e, r) {
      ;(function (t) {
        !(function () {
              ...
              Ua = function () {
                var t =
                    arguments.length < 1 || void 0 === arguments[0]
                      ...
                      : String(arguments[0]),
                  e =
                    this instanceof Ua ? new Ta(t) : void 0 === t ? Ta() : Ta(t)
                return '' === t && (La[e] = !0), e
              }
            St(Ua, Ta)
              ...
              if (
                ...
                if (y(c))
                  if ('function' == typeof (t = ir(c)))
                    ...
                    for (s in c) w(c, s) && f.push({ key: s, value: c[s] + '' })
                else
                  Wu(
                    f,
                    'string' == typeof c
          ...
          if (Ff.arrayBuffer)
            var Bf = [
              ...
              Df =
                ArrayBuffer.isView ||
                function (t) {
                  return t && Bf.indexOf(Object.prototype.toString.call(t)) > -1
                }
          function qf(t) {
            if (
          ...
          var Yf = ['DELETE', 'GET', 'HEAD', 'OPTIONS', 'POST', 'PUT']
          function Jf(t, e) {
            var r,
              n,
              o = (e = e || {}).body
          ...
          ;(Jf.prototype.clone = function () {
            ...
            (Zf.error = function () {
              var t = new Zf(null, { status: 0, statusText: '' })
