  ...
  [792],
  {
    ...
    9994: (e, t, r) => {
      ...
      function $(e) {
        var t;
        let { children: r } = e,
          a = y.default.useMemo(() => (0, k.adaptForAppRouterInstance)(n), []);
        return (0, g.jsx)(z, {
          fn: (e) =>
                    ...
                    children: (0, g.jsx)(P.HeadManagerContext.Provider, {
                      ...
                      children: (0, g.jsx)(N.ImageConfigContext.Provider, {
                        value: {
                          ...
                          path: '/damianzamolski.github.io/_next/image',
                          loader: 'default',
      ...
      function eu(e) {
        ...
        a = a || l.Component;
        let f = { ...(o = o || l.props), Component: a, err: i, router: n };
        l = f;
        let d = !1,
          p = new Promise((e, r) => {
            c && c(),
    ...
    2893: (e, t, r) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), r(9473);
      let n = r(9994);
      (window.next = {
        version: n.version,
        get router() {
    ...
    1768: (e, t, r) => {
      ...
      let n = r(1739)._(r(758)).default.createContext({});
    },
    8884: (e, t) => {
      'use strict';
      function r(e) {
    ...
    8543: (e, t, r) => {
      ...
      let n = r(1739)._(r(758)).default.createContext(null);
    },
    4578: (e, t, r) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    4151: (e, t, r) => {
      ...
      class Y {
        ...
        async change(e, t, r, n, a) {
          ...
          let ea = r;
          er = er ? (0, o.removeTrailingSlash)((0, v.removeBasePath)(er)) : er;
          ...
          (ea = (0, b.removeLocale)((0, v.removeBasePath)(ea), q.locale)),
          ...
          try {
            ...
            if ('type' in o) {
              ...
              return (
                V({ url: o.destination, router: this }), new Promise(() => {})
              );
            }
            let i = o.Component;
            if (
              ...
              if (
                ((q.isPreview = !!o.props.__N_PREVIEW), o.props.notFound === W)
              ) {
                let e;
                try {
            ...
            let l = n.shallow && q.route === (null != (T = o.route) ? T : eo),
            ...
            if (
              ...
              if (o.error)
                throw (
                  (B || Y.events.emit('routeChangeError', o.error, Z, J),
                  o.error)
                );
        ...
        async handleRouteInfoError(e, t, r, n, a, o) {
          ...
          if ((0, i.isAssetError)(e) || o)
            throw (
              (Y.events.emit('routeChangeError', e, n, a),
              V({ url: n, router: this }),
              D())
            );
          console.error(e);
        ...
        async prefetch(e, t, r) {
          ...
          if (
            ...
            return;
          let T = (0, o.removeTrailingSlash)(s);
        ...
        constructor(
          ...
          if (
            ((this.basePath = '/damianzamolski.github.io'),
            (this.sub = c),
            (this.clc = null),
            (this._wrapApp = s),
            (this.isSsr = !0),
        ...
        (() => {
          ...
          function n(e, t, r) {
            ...
            return function (r) {
              ...
              if (!n) return !1;
              for (
                var o = n[0], i = n.index, s = Object.create(null), u = 1;
                u < n.length;
                u++
              )
                !(function (e) {
