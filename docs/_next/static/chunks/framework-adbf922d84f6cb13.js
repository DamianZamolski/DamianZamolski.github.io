  ...
  [593],
  {
    9481: (e, n, t) => {
      ...
      var t5 =
        ...
        t9 = new Set(
          'cancel close invalid load scroll toggle'.split(' ').concat(t5),
        );
      function t7(e, n, t) {
      ...
      function l9() {
        for (var e = 0; e < l5.length; e++)
          l5[e]._workInProgressVersionPrimary = null;
        l5.length = 0;
      }
      ...
      function o$(e, n, t) {
        ...
        null !== r && r.delete(n),
          ...
          u2 === e &&
            (u4 & t) === t &&
            (4 === u5 ||
            (3 === u5 && (0x7c00000 & u4) === u4 && 500 > eZ() - ol)
              ? oz(e, 0)
              : (on |= t)),
          ok(e, n);
      }
