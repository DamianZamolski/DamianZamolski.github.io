    ...
    1235: (e, t, r) => {
      ...
      function g(e) {
        let t,
          r,
          n,
          [a, g] = (0, u.useOptimistic)(p.IDLE_LINK_STATUS),
          b = (0, u.useRef)(null),
          {
            href: P,
            as: _,
        ...
        let K = L ? r && 'object' == typeof r && r.ref : M,
          B = u.default.useCallback(
            (e) => (
              null !== k &&
                (b.current = (0, p.mountLinkInstance)(e, D, k, w, I, g)),
              () => {
                (b.current &&
        ...
        return (
          ...
          (n = L
            ...
            : (0, o.jsx)('a', { ...R, ...z, children: t })),
          (0, o.jsx)(m.Provider, { value: a, children: n })
        );
      }
      r(1069);
