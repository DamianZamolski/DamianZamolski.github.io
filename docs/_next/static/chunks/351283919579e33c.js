(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, r, t) => {
    ...
    function i({ notFound: e, forbidden: r, unauthorized: t, children: n }) {
  ...
  (e, r, t) => {
    ...
    function a(e, r) {
      ...
      for (; null !== u && c < 1; ) {
        ...
        {
          c++;
          let e = { tree: u.tree, stateKey: u.stateKey, next: null };
          ((l.next = e), (l = e));
        }
        u = u.next;
      }
  ...
  (e, r, t) => {
            ...
            if (e.apply) {
              if (
                ...
                !e.segmentPaths.some((e) =>
                  r.every((r, t) => (0, p.matchSegment)(r, e[t])),
                )
              )
                return;
              let t = null,
                ...
                (0, h.disableSmoothScrollDuringRouteTransition)(
                  () => {
                    ...
                    let e = document.documentElement,
                      r = e.clientHeight;
                    !R(t, r) &&
                      ((e.scrollTop = 0), R(t, r) || t.scrollIntoView());
                  },
    ...
    function w({ segmentPath: e, children: r }) {
    ...
    function C({
      ...
      if (((0, u.useContext)(v.NavigationPromisesContext), !h))
        throw Object.defineProperty(
          Error('invariant global layout router not mounted'),
          '__NEXT_ERROR_CODE',
          { value: 'E473', enumerable: !1, configurable: !0 },
      ...
      let { tree: m } = h,
        g = null !== n.prefetchRsc ? n.prefetchRsc : n.rsc,
        y = (0, u.useDeferredValue)(n.rsc, g),
        _ =
        ...
        if (f) {
          ...
          if (null === e) {
            let t = (function e(r, t) {
              ...
              o = Date.now();
            ((n.lazyData = e =
              (0, i.fetchServerResponse)(new URL(l, location.origin), {
                flightRouterState: t,
    ...
    function x({ name: e, loading: r, children: t }) {
      let n;
      if (
        (n =
        ...
        return (0, o.jsx)(u.Suspense, {
          name: e,
          fallback: (0, o.jsxs)(o.Fragment, { children: [a, c, r] }),
          children: t,
        });
      }
      return (0, o.jsx)(o.Fragment, { children: t });
    }
    function T({
      parallelRouterKey: e,
      error: r,
  ...
  (e, r, t) => {
    ...
    let n = e.r(35045).createRenderSearchParamsFromClient;
    ('function' == typeof t.default ||
      ('object' == typeof t.default && null !== t.default)) &&
      void 0 === t.default.__esModule &&
      (Object.defineProperty(t.default, '__esModule', { value: !0 }),
  ...
  (e, r, t) => {
    ...
    let n = e.r(63504).createRenderParamsFromClient;
    ('function' == typeof t.default ||
      ('object' == typeof t.default && null !== t.default)) &&
      void 0 === t.default.__esModule &&
      (Object.defineProperty(t.default, '__esModule', { value: !0 }),
  ...
  (e, r, t) => {
    ...
    let n = (0, e.r(41362).createAsyncLocalStorage)();
  },
  64926,
  (e, r, t) => {
    'use strict';
  ...
  (e, r, t) => {
                ...
                if ('string' == typeof r && 'then' === r) {
                  ...
                  i.dynamicShouldError
                    ...
                    : 'prerender-ppr' === d.type
                      ? (0, c.postponeWithTracking)(
                          i.route,
                          e,
                          d.dynamicTracking,
                        )
                      : (0, c.throwToInterruptStaticGeneration)(e, i, d);
                }
                return o.ReflectAdapter.get(e, r, t);
              },
            });
          ...
          get: function r(n, a, c) {
            return (
              Object.hasOwn(t, a) ||
                ...
                (0, f.throwForSearchParamsAccessInUseCache)(e, r),
              o.ReflectAdapter.get(n, a, c)
            );
          },
        });
      return (_.set(e, n), n);
    ...
    (0, i.createDedupedByCallsiteServerErrorLoggerDev)(function (e, r) {
      ...
      return Object.defineProperty(
        Error(
          `${t}used ${r}. \`searchParams\` is a Promise and must be unwrapped with \`await\` or \`React.use()\` before accessing its properties. Learn more: https://nextjs.org/docs/messages/sync-dynamic-apis`,
        ),
        '__NEXT_ERROR_CODE',
  ...
  (e, r, t) => {
                      ...
                      i.wellKnownProperties.has(e) ||
                        (r.has(e) &&
                          Object.defineProperty(o, e, {
                            get() {
                              let r = (0, i.describeStringPropertyAccess)(
                                'params',
                                e,
                              );
                              'prerender-ppr' === n.type
                                ? (0, u.postponeWithTracking)(
                                    t.route,
                                    r,
                                    n.dynamicTracking,
                                  )
                                : (0, u.throwToInterruptStaticGeneration)(
                                    r,
                                    t,
                                    n,
                                  );
    ...
    (0, f.createDedupedByCallsiteServerErrorLoggerDev)(function (e, r) {
      ...
      return Object.defineProperty(
        Error(
          `${t}used ${r}. \`params\` is a Promise and must be unwrapped with \`await\` or \`React.use()\` before accessing its properties. Learn more: https://nextjs.org/docs/messages/sync-dynamic-apis`,
        ),
        '__NEXT_ERROR_CODE',
  ...
  (e, r, t) => {
    ...
    let n = e.r(78042),
      ...
      u = e.r(93969),
      l = e.r(18057);
    function s({ Component: r, serverProvidedParams: t }) {
      let s, i;
      if (null !== t) ((s = t.searchParams), (i = t.params));
      else {
        let e = (0, c.use)(o.LayoutRouterContext);
        ((i = null !== e ? e.parentParams : {}),
          (s = (0, u.urlSearchParamsToParsedUrlQuery)(
            (0, c.use)(l.SearchParamsContext),
          )));
      }
      if ('undefined' == typeof window) {
        let t,
          o,
          { workAsyncStorage: c } = e.r(35772),
          u = c.getStore();
        if (!u)
          throw Object.defineProperty(
        ...
        let { createSearchParamsFromClient: l } = e.r(23680);
        t = l(s, u);
        let { createParamsFromClient: d } = e.r(16316);
        return ((o = d(i, u)), (0, n.jsx)(r, { params: o, searchParams: t }));
      }
      {
        let { createRenderSearchParamsFromClient: t } = e.r(99363),
          a = t(s),
          { createRenderParamsFromClient: o } = e.r(80312),
          c = o(i);
        return (0, n.jsx)(r, { params: c, searchParams: a });
      }
    }
    ('function' == typeof t.default ||
      ('object' == typeof t.default && null !== t.default)) &&
  ...
  (e, r, t) => {
    ...
    let n = e.r(78042),
      ...
      o = e.r(54080),
      c = e.r(45456);
    function u({ Component: r, slots: t, serverProvidedParams: u }) {
      let l;
      ...
      if ('undefined' == typeof window) {
        ...
        let { createParamsFromClient: s } = e.r(16316);
        return ((o = s(l, u)), (0, n.jsx)(r, { ...t, params: o }));
      }
      {
        let { createRenderParamsFromClient: a } = e.r(80312),
          o = a(l);
        return (0, n.jsx)(r, { ...t, params: o });
      }
    }
    ('function' == typeof t.default ||
      ('object' == typeof t.default && null !== t.default)) &&
