  ...
  [3],
  {
    ...
    IKlv: function (e, t, n) {
      ...
      var M = C.props,
        ...
        j = L || ''
      ;(n.p = ''.concat(j, '/_next/')),
        T.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: A || {} })
      var H = (0, b.getURL)()
      ;(0, P.hasBasePath)(H) && (H = (0, P.delBasePath)(H))
      var U = new x.default(D, j, I),
        O = function (e) {
          var t = f(e, 2),
            n = t[0],
            r = t[1]
                    ...
                    G.isSsr &&
                      ...
                      G.replace(
                        G.pathname +
                          ...
                          String(
                            v.assign(
                              v.urlQueryToSearchParams(G.query),
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 25:
                      ...
                      return (e.next = 29), window.__NEXT_PRELOADREADY(B)
                    case 29:
                      return (
                        (t.router = G = (0, h.createRouter)(I, F, H, {
                          initialProps: M,
                          pageLoader: U,
                          App: J,
                          Component: Y,
                        ...
                        ee({ App: J, Component: Y, props: M, err: u }),
                        e.abrupt('return', Q)
                      )
                    case 35:
                      e.next = 37
          ...
          U.loadPage('/_error').then(function (r) {
            var a = r.page,
              ...
              i = {
                ...
                AppTree: o,
                router: G,
                ctx: { err: n, pathname: I, query: F, asPath: H, AppTree: o },
              }
            return Promise.resolve(
              e.props ? e.props : (0, b.loadGetInitialProps)(t, i)
            ).then(function (t) {
              return se(
                (0, m.default)(
                  (0, m.default)({}, e),
      ...
      function ue(e) {
        ...
        return g.default.createElement(
          ...
          {
            fn: function (e) {
              return ne({ App: J, err: e }).catch(function (e) {
    ...
    zmvN: function (e, t, n) {
      ...
      var g = h('preload') && !h('prefetch') ? 'preload' : 'prefetch',
        y =
            ...
            },
            {
              ...
              value: function (e, t, n) {
                var r,
                  ...
                  h = o.searchParams,
                  v = o.search,
                  g = (0, d.searchParamsToUrlQuery)(h),
                ...
                if (S) {
                  var T = (0, m.getRouteRegex)(w),
                    b = T.groups,
                    P = (0, p.getRouteMatcher)(T)(y) || g
                  ;(r = w),
