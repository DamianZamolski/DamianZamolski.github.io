      ...
      A.exports = (function () {
        ...
        var ei = function (A, e) {
            var t = e.filter(AZ),
              ...
              s = t[3],
              o =
                (17 === r.type ? eA(r.number) : A6.parse(A, r)) / (2 * Math.PI),
          ...
          eQ = function (A, e) {
            return ee.parse(A, AR.create(e).parseComponentValue());
          },
          ec = {
            ...
            t4 = function (A, e, t) {
              ...
              switch (e.type) {
                ...
                case 3:
                  switch (e.format) {
                    case 'angle':
                      return A6.parse(A, n.parseComponentValue());
                    case 'color':
                      return ee.parse(A, n.parseComponentValue());
                    case 'image':
                      return ev.parse(A, n.parseComponentValue());
                    case 'length':
        ...
        var rB = function (A) {
          ...
          rM = function (A, e) {
            for (
              ...
              if (t.value) {
                var n = x(t.value.slice()),
                  s = '';
                (n.forEach(function (A) {
                  -1 === rx.indexOf(A)
                    ? (s += M(A))
                    : (s.length && B.push(s), B.push(M(A)), (s = ''));
                }),
                  s.length && B.push(s));
              }
            return B;
                  ...
                  case 0:
                    ...
                    if (
                      ((B = {
                        ...
                        imageTimeout: null != (E = r.imageTimeout) ? E : 15e3,
                        proxy: r.proxy,
                        useCORS: null != (I = r.useCORS) && I,
                      }),
                      (o = new nS(
                        y(
                          {
                            logging: null == (K = r.logging) || K,
                            cache: r.cache,
                          },
                          B,
                        ),
                        (s = new b(
                          (n = {
                            windowWidth:
                              null != (L = r.windowWidth) ? L : e.innerWidth,
                            windowHeight:
                              null != (x = r.windowHeight) ? x : e.innerHeight,
                            scrollX:
                              null != (M = r.scrollX) ? M : e.pageXOffset,
                            scrollY:
                              null != (S = r.scrollY) ? S : e.pageYOffset,
                          }).scrollX,
                          n.scrollY,
                          n.windowWidth,
                          n.windowHeight,
                      ...
                      (i = null != (T = r.foreignObjectRendering) && T),
                      (a = {
                        allowTaint: null != (G = r.allowTaint) && G,
                        onclone: r.onclone,
                  ...
                  case 1:
                    if (
                      ...
                      (f = {
                        ...
                        scale:
                          null !=
                          (V = null != (O = r.scale) ? O : e.devicePixelRatio)
                            ? V
                            : 1,
                        x: (null != (k = r.x) ? k : 0) + u,
                        y: (null != (R = r.y) ? R : 0) + C,
                        width: null != (N = r.width) ? N : Math.ceil(l),
                        height: null != (P = r.height) ? P : Math.ceil(U),
                      }),
                      !i)
                    )
                      return [3, 3];
                  ...
                  case 3:
                    return (
                      ...
                      F === H.styles.backgroundColor &&
                        (H.styles.backgroundColor = ec.TRANSPARENT),
                      o.logger.debug(
                      ...
                      [4, new ny(o, f).render(H)]
                    );
                  case 4:
                    ((h = d.sent()), (d.label = 5));
                  case 5:
                    return (
                      (null == (X = r.removeContainer) || X) &&
                        !Bb.destroy(g) &&
                        o.logger.error(
