(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function g(t) {
      ...
      let A = a.default.useContext(c.AppRouterContext),
        $ = !1 !== O,
        I =
          !1 !== O
            ? null === (r = O) || 'auto' === r
      ...
      let D = w ? o && 'object' == typeof o && o.ref : M,
        K = a.default.useCallback(
          (e) => (
            null !== A &&
              (P.current = (0, p.mountLinkInstance)(e, B, A, I, $, g)),
            () => {
              (P.current &&
                ((0, p.unmountLinkForCurrentNavigation)(P.current),
                (P.current = null)),
        ...
        z = {
          ...
          onMouseEnter(e) {
            (w || 'function' != typeof R || R(e),
              ...
              A && $ && (0, p.onNavigationIntent)(e.currentTarget, !0 === U));
          },
      ...
      return (
        (0, f.isAbsoluteUrl)(F)
          ? (z.href = F)
          : (w && !E && ('a' !== o.type || 'href' in o.props)) ||
            (z.href = (0, d.addBasePath)(F)),
        (u = w
          ? a.default.cloneElement(o, z)
          : (0, i.jsx)('a', { ...k, ...z, children: n })),
  ...
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/cf4fc1e20e39d4cb.js'].map((t) => e.l(t)),
      ).then(() => t(21487)),
    );
  },
  61886,
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/459df8a27d33d860.js'].map((t) => e.l(t)),
      ).then(() => t(12867)),
    );
  },
  23548,
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/ffca5530e39fca7c.js'].map((t) => e.l(t)),
      ).then(() => t(29685)),
    );
  },
]);
