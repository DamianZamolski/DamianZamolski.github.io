              ...
              value: (function () {
                var e = a(
                  o.mark(function e(r, n, a, i) {
                    var u, c, s, g, m, w, S, k, P, E, O, L, C, j
                    return o.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 48:
                              ...
                              throw (t.events.emit('routeChangeError', j, u), j)
                            case 51:
                              return (
            ...
            (a._invoke = (function (t, e, r) {
              ...
              return function (o, a) {
                ...
                for (r.method = o, r.arg = a; ; ) {
                  ...
                  var c = h(t, e, r)
                  if ('normal' === c.type) {
                    if (((n = r.done ? v : f), c.arg === d)) continue
          ...
          (O.prototype = {
            ...
            finish: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                if (r.finallyLoc === t)
                  return this.complete(r.completion, r.afterLoc), R(r), d
              }
            },
            catch: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
