...
You are eliminated if all of your home system's planet cards are purged.`}],l=i.map(e=>e.id),h=Array.from(new Set(i.map(e=>e.source))).map(e=>({source:e,events:i.filter(t=>t.source===e)})),c=(0,a.atomWithStorage)("ti4-galactic-event-pool",l);e.s(["default",0,function(){let[e,a]=(0,o.useAtom)(c),[d,u]=(0,n.useState)(1),[m,p]=(0,n.useState)([]),[y,f]=(0,n.useState)(!1);(0,n.useEffect)(()=>{let e=new URLSearchParams(window.location.search),t=e.get("pool"),o=e.get("drawn");null!==t&&a(t.split(",").filter(e=>l.includes(e))),null!==o&&p(o.split(",").filter(e=>l.includes(e)))},[a]),(0,n.useEffect)(()=>{u(t=>Math.min(Math.max(1,t),Math.max(1,e.length)))},[e.length]);let g=(0,n.useMemo)(()=>new Set(e),[e]),b=(0,n.useMemo)(()=>m.map(e=>i.find(t=>t.id===e)).filter(e=>!!e),[m]),v=async()=>{let t=new URLSearchParams({pool:e.join(","),drawn:m.join(",")}),a=`${window.location.origin}${window.location.pathname}?${t.toString()}`;await navigator.clipboard.writeText(a),f(!0),setTimeout(()=>f(!1),1500)};return(0,t.jsxs)(r.Page,{children:[(0,t.jsxs)("form",{onSubmit:t=>{t.preventDefault();let a=Math.min(Math.max(1,d),e.length);p((0,s.shuffleArray)([...e]).slice(0,a)),f(!1)},children:[h.map(({source:e,events:o})=>(0,t.jsxs)("fieldset",{children:[(0,t.jsx)("legend",{children:(0,t.jsxs)("label",{children:[(0,t.jsx)("input",{type:"checkbox",checked:o.every(e=>g.has(e.id)),onChange:()=>{let e,t;return t=(e=o.map(e=>e.id)).every(e=>g.has(e)),void a(a=>t?a.filter(t=>!e.includes(t)):Array.from(new Set([...a,...e])))}}),(0,t.jsx)("strong",{children:e})]})}),o.map(e=>(0,t.jsxs)("label",{children:[(0,t.jsx)("input",{type:"checkbox",checked:g.has(e.id),onChange:()=>{var t;return t=e.id,void a(e=>e.includes(t)?e.filter(e=>e!==t):[...e,t])}}),e.name," ",(0,t.jsxs)("small",{children:["(complexity ",e.complexity,")"]})]},e.id))]},e)),(0,t.jsxs)("label",{children:["Draw",(0,t.jsx)("input",{type:"number",min:1,max:Math.max(1,e.length),value:d,onChange:t=>u(Math.min(Math.max(1,Number(t.target.value)||1),Math.max(1,e.length)))})]}),(0,t.jsx)("button",{type:"submit",disabled:0===e.length,children:"Draw events"})]}),b.length>0&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("ul",{children:b.map(e=>(0,t.jsxs)("li",{children:[(0,t.jsx)("strong",{children:e.name})," — complexity ",e.complexity,(0,t.jsxs)("details",{children:[(0,t.jsx)("summary",{children:"Effect"}),(0,t.jsx)("div",{style:{whiteSpace:"pre-wrap"},children:e.effect})]})]},e.id))}),(0,t.jsx)("button",{type:"button",onClick:v,children:"Share"}),y&&(0,t.jsx)("small",{role:"status",children:"Copied"})]})]})}],79697)}]);