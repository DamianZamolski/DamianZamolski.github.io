  ...
  [5],
  {
    'MO+k': function (t, e, n) {
      t.exports = (function (t) {
        ...
        var Nt = nt.extend({
          ...
          update: function (t) {
            ...
            if (m < Rt) {
              var b = l.rotation % Rt,
                ...
                S = (b <= zt && x >= zt) || x >= Rt + zt,
                C = (b <= -zt && x >= -zt) || x >= Lt + zt,
                P = b === -Lt || x >= Lt ? -1 : Math.min(y, y * p, k, k * p),
          ...
          setHoverStyle: function (t) {
            ...
            ;(t.$previousStyle = {
              ...
              (e.backgroundColor = Ot(
                n.hoverBackgroundColor,
                i(n.backgroundColor)
              )),
              (e.borderColor = Ot(n.hoverBorderColor, i(n.borderColor))),
              (e.borderWidth = Ot(n.hoverBorderWidth, n.borderWidth))
          },
        ...
        var Ut = nt.extend({
            ...
            _resolveDatasetElementOptions: function (t) {
              var e = this,
                ...
                a = e.chart.options,
                r = a.elements.line,
                o = nt.prototype._resolveDatasetElementOptions.apply(
                  e,
                  arguments
                )
              return (
          ...
          var i,
            ...
            l = (s.resizer = (function (t) {
              var e = we('chartjs-size-monitor'),
                ...
                i = we('chartjs-size-monitor-shrink')
              n.appendChild(we()),
                i.appendChild(we()),
                e.appendChild(n),
                e.appendChild(i),
        ...
        ;(V.addEvent = ye), (V.removeEvent = _e)
        var Pe = Ce._enabled
            ? Ce
            : {
        ...
        function Le(t, e) {
          return (
            e && (V.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
            t
          )
        }
        function Re(t) {
        ...
        var Ee = G.extend({
            ...
            getTitle: function () {
              var t = this,
                ...
                o = []
              return (o = Le(o, Re(i))), (o = Le(o, Re(a))), (o = Le(o, Re(r)))
            },
            ...
            getBody: function (t, e) {
              ...
              return (
                V.each(t, function (t) {
                  ...
                  Le(r.before, Re(i.beforeLabel.call(n, t, e))),
                    Le(r.lines, i.label.call(n, t, e)),
                    Le(r.after, Re(i.afterLabel.call(n, t, e))),
                    a.push(r)
                }),
                a
              )
            ...
            getFooter: function () {
              var t = this,
                ...
                r = []
              return (r = Le(r, Re(n))), (r = Le(r, Re(i))), (r = Le(r, Re(a)))
            },
            update: function (t) {
              var e,
                n,
              ...
              if (p.length) {
                ...
                var _ = [],
                  k = []
                y = Oe[c.position].call(h, p, h._eventPosition)
                var w = []
            ...
            merger: function (t, e, n, i) {
              if ('xAxes' === t || 'yAxes' === t) {
                ...
                for (e[t] || (e[t] = []), a = 0; a < s; ++a)
                  (o = n[t][a]),
                    (r = He(o.type, 'xAxes' === t ? 'category' : 'linear')),
                    a >= e[t].length && e[t].push({}),
                    !e[t][a].type || (o.type && o.type !== e[t][a].type)
                      ? V.merge(e[t][a], [Te.getScaleDefaults(r), o])
                      : V.merge(e[t][a], o)
          ...
          return V.merge({}, [].slice.call(arguments), {
            merger: function (t, e, n, i) {
              ...
              'scales' === t
                ? (e[t] = je(a, r))
                : 'scale' === t
                ? (e[t] = V.merge(a, [Te.getScaleDefaults(r.type), r]))
                : V._merger(t, e, n, i)
            },
          })
        }
        function Ue(t) {
          ...
          V.each(t.scales, function (e) {
            ...
            (e = qe(z.global, z[t.config.type], e)),
        ...
        V.extend(Xe.prototype, {
          construct: function (t, e) {
            ...
            e = (function (t) {
              ...
              return (
                ...
                (e.labels = e.labels || []),
                (t.options = qe(z.global, z[t.type], t.options || {})),
                t
              )
            })(e)
            var i = Ae.acquireContext(t, e),
              a = i && i.canvas,
              r = a && a.height,
              o = a && a.width
            ;(n.id = V.uid()),
          ...
          ensureScalesHaveIDs: function () {
            ...
            V.each(e.xAxes, function (t, n) {
              t.id || (t.id = Ye(e.xAxes, 'x-axis-', n))
            }),
              V.each(e.yAxes, function (t, n) {
                t.id || (t.id = Ye(e.yAxes, 'y-axis-', n))
              }),
              n && (n.id = n.id || 'scale')
          },
          ...
          update: function (t) {
            ...
            if (
              ...
              i.updateLayout(),
                ...
                (i.lastActive = []),
                De.notify(i, 'afterUpdate'),
                i._layers.sort(Ge('z', '_idx')),
                i._bufferedRender
                  ? (i._bufferedRequest = {
                      duration: t.duration,
                      easing: t.easing,
          ...
          updateDataset: function (t) {
            ...
            !1 !== De.notify(this, 'beforeDatasetUpdate', [n]) &&
              ...
              De.notify(this, 'afterDatasetUpdate', [n]))
          },
          render: function (t) {
            var e = this
            ;(t && 'object' == typeof t) ||
          ...
          _getSortedDatasetMetas: function (t) {
            ...
            return i.sort(Ge('order', 'index')), i
          },
          ...
          destroy: function () {
            ...
            i &&
              (n.unbindEvents(),
              V.canvas.clear(n),
              Ae.releaseContext(n.ctx),
              (n.canvas = null),
              (n.ctx = null)),
              De.notify(n, 'destroy'),
              delete Xe.instances[n.id]
          },
          ...
          bindEvents: function () {
            ...
            V.each(t.options.events, function (i) {
              Ae.addEventListener(t, i, n), (e[i] = n)
            }),
              t.options.responsive &&
                ((n = function () {
                  t.resize()
                }),
                Ae.addEventListener(t, 'resize', n),
                (e.resize = n))
          },
        ...
        function hn(t) {
          var e = dn(t, t.minor)
          return { minor: e, major: t.major.enabled ? dn(t, t.major) : e }
        }
        function cn(t) {
          var e,
            n,
        ...
        var gn = G.extend({
          ...
          afterBuildTicks: function (t) {
            ...
            return en(t) && t.length
              ...
              : ((e.ticks =
                  V.callback(e.options.afterBuildTicks, [e, e.ticks]) ||
                  e.ticks),
                t)
          },
          ...
          fit: function () {
            var t = this,
              ...
              u = t.isHorizontal()
            if (
              (u ? (e.width = t.maxWidth) : s && (e.width = ln(o) + un(r)),
              u ? s && (e.height = ln(o) + un(r)) : (e.height = t.maxHeight),
              a.display && s)
            ) {
              var d = hn(a),
                h = t._getLabelSizes(),
          ...
          _autoSkip: function (t) {
            ...
            if (
              ((i = (function (t, e, n, i) {
                ...
                for (
                  o = 0, s = (a = V.math._factorize(l)).length - 1;
                  o < s;
                  o++
                )
                  if ((r = a[o]) > u) return r
              ...
              for (e = 0, n = u - 1; e < n; e++) fn(t, i, l[e], l[e + 1])
              return (
                (a = u > 1 ? (h - d) / (u - 1) : null),
                fn(t, i, V.isNullOrUndef(a) ? 0 : d - a, d),
                fn(t, i, h, V.isNullOrUndef(a) ? t.length : h + a),
                cn(t)
              )
            }
            return fn(t, i), cn(t)
          ...
          _computeGridLineItems: function (t) {
            var e,
              ...
              P = ln(_),
              A = [],
              D = _.drawBorder ? rn(_.lineWidth, 0, 0) : 0,
              T = D / 2,
              I = V._alignPixel,
              F = function (t) {
                return I(x, t, D)
          ...
          _drawGrid: function (t) {
            ...
            if (n.display) {
              var i,
                ...
                u = e.chart,
                d = V._alignPixel,
                h = n.drawBorder ? rn(n.lineWidth, 0, 0) : 0,
                c =
                  e._gridLineItems ||
              ...
              if (h) {
                var f,
                  ...
                  m,
                  v = h,
                  b = rn(n.lineWidth, c.ticksLength - 1, 1),
                  x = c.borderValue
                e.isHorizontal()
                  ? ((f = d(u, e.left, v) - v / 2),
                    (g = d(u, e.right, b) + b / 2),
          ...
          _drawTitle: function () {
            ...
            if (i.display) {
              var a,
                r,
                o = an(i.fontColor, z.global.defaultFontColor),
        ...
        var xn = V.noop,
          ...
          _n = pn.extend({
            getRightValue: function (t) {
              return 'string' == typeof t
                ? +t
                : pn.prototype.getRightValue.call(this, t)
            },
            ...
            buildTicks: function () {
              var t = this,
                ...
                a = (t.ticks = (function (t, e) {
                  ...
                  if (p < 1e-14 && yn(d) && yn(h)) return [f, g]
                  ;(r = Math.ceil(g / p) - Math.floor(f / p)) > u &&
                    ...
                    (a = Math.ceil(g / p) * p),
                    s &&
                      (!yn(d) && V.almostWhole(d / p, p / 1e3) && (i = d),
                      !yn(h) && V.almostWhole(h / p, p / 1e3) && (a = h)),
                    (r = (a - i) / p),
          ...
          kn = { position: 'left', ticks: { callback: tn.formatters.linear } }
        function wn(t, e, n, i) {
          var a,
            r,
            o = t.options,
        ...
        var Sn = _n.extend({
            determineDataLimits: function () {
              ...
              for (t = 0; t < d; ++t)
                (n = o[(e = s[t]).index].data), l ? wn(a, u, e, n) : Mn(a, e, n)
              V.each(u, function (t) {
        ...
        var In = pn.extend({
            ...
            handleTickRangeOptions: function () {
              var t = this,
                e = t.options.ticks
              ;(t.min = Tn(e.min, t.min)),
                (t.max = Tn(e.max, t.max)),
                t.min === t.max &&
                  (0 !== t.min && null !== t.min
                    ? ((t.min = Math.pow(10, Math.floor(An(t.min)) - 1)),
                      (t.max = Math.pow(10, Math.floor(An(t.max)) + 1)))
                    : ((t.min = 1), (t.max = 10))),
                null === t.min &&
                  (t.min = Math.pow(10, Math.floor(An(t.max)) - 1)),
                null === t.max &&
                  (t.max =
                    0 !== t.min ? Math.pow(10, Math.floor(An(t.min)) + 1) : 10),
                null === t.minNotZero &&
                  (t.min > 0
                    ? (t.minNotZero = t.min)
                    : t.max < 1
                    ? (t.minNotZero = Math.pow(10, Math.floor(An(t.max))))
                    : (t.minNotZero = 1))
            },
            buildTicks: function () {
              var t = this,
                e = t.options.ticks,
                n = !t.isHorizontal(),
                i = { min: Tn(e.min), max: Tn(e.max) },
                a = (t.ticks = (function (t, e) {
                  var n,
                    i,
                    a = [],
                    r = Pn(t.min, Math.pow(10, Math.floor(An(e.min)))),
                    o = Math.floor(An(e.max)),
                    s = Math.ceil(e.max / Math.pow(10, o))
                  0 === r
                    ? ((n = Math.floor(An(e.minNotZero))),
            ...
            _configure: function () {
              ...
              pn.prototype._configure.call(t),
                0 === e &&
                  ...
                  (n =
                    Pn(t.options.ticks.fontSize, z.global.defaultFontSize) /
                    t._length)),
                (t._startValue = An(e)),
                (t._valueOffset = n),
                (t._valueRange = (An(t.max) - An(e)) / (1 - n))
            },
            getPixelForValue: function (t) {
              var e = this,
                n = 0
              return (
                (t = +e.getRightValue(t)) > e.min &&
                  t > 0 &&
                  (n =
                    (An(t) - e._startValue) / e._valueRange + e._valueOffset),
          ...
          Fn = Dn
        In._defaults = Fn
        var On = V.valueOrDefault,
          Ln = V.valueAtIndexOrDefault,
          Rn = V.options.resolve,
          zn = {
            display: !0,
            animate: !0,
            position: 'chartArea',
        ...
        function Nn(t) {
          ...
          return e.display && t.display
            ? On(e.fontSize, z.global.defaultFontSize) + 2 * e.backdropPaddingY
            : 0
        }
        ...
        var jn = _n.extend({
            ...
            _drawGrid: function () {
              var t,
                ...
                o = r.gridLines,
                s = r.angleLines,
                l = On(s.lineWidth, o.lineWidth),
                u = On(s.color, o.color)
              if (
                  ...
                  (function (t) {
                    ...
                    for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                      var l = 0 === s ? a / 2 : 0,
                        ...
                        d = Ln(i.fontColor, s, z.global.defaultFontColor)
                      e.fillStyle = d
                ...
                for (
                  a.save(),
                    ...
                    a.strokeStyle = u,
                    a.setLineDash &&
                      (a.setLineDash(Rn([s.borderDash, o.borderDash, []])),
                      (a.lineDashOffset = Rn([
                        s.borderDashOffset,
                        o.borderDashOffset,
                        0,
            ...
            _drawLabels: function () {
              ...
              if (n.display) {
                var i,
                  ...
                  s = On(n.fontColor, z.global.defaultFontColor)
                e.save(),
                  (e.font = o.string),
          ...
          qn = zn
        jn._defaults = qn
        var Un = V._deprecated,
          Yn = V.options.resolve,
          $n = V.valueOrDefault,
        ...
        function ii(t, e) {
          ...
          var n = t.options.time,
            i = ni(t, t.getRightValue(e))
          return (
            null === i || (n.round && (i = +t._adapter.startOf(i, n.round))), i
          )
        }
        function ai(t, e, n, i) {
          var a,
            ...
            o,
            s = Zn.length
          for (a = Zn.indexOf(t); a < s - 1; ++a)
            if (
              ((o = (r = Kn[Zn[a]]).steps ? r.steps : Xn),
        ...
        var oi = pn.extend({
            ...
            buildTicks: function () {
              ...
              return (
                ...
                (i._unit =
                  l.unit ||
                  (s.autoSkip
                    ? ai(l.minUnit, i.min, i.max, h)
                    : (function (t, e, n, i, a) {
                        var r, o
                        for (r = Zn.length - 1; r >= Zn.indexOf(n); r--)
                          if (
                            ((o = Zn[r]),
                            Kn[o].common && t._adapter.diff(a, i, o) >= e - 1)
                          )
                            return o
                        return Zn[n ? Zn.indexOf(n) : 0]
                      })(i, d.length, l.minUnit, i.min, i.max))),
                (i._majorUnit =
                  s.major.enabled && 'year' !== i._unit
                    ? (function (t) {
                        for (
                          var e = Zn.indexOf(t) + 1, n = Zn.length;
                          e < n;
                          ++e
                        )
                          if (Kn[Zn[e]].common) return Zn[e]
                      })(i._unit)
                    : void 0),
                  ...
                  return (
                    a.offset &&
                      ...
                      (s =
                        1 === e.length
                          ? 1 - r
                          : (ei(t, 'time', e[1], 'pos') - r) / 2),
                      (o = ei(t, 'time', e[e.length - 1], 'pos')),
                      (l =
                        1 === e.length
                          ? o
                          : (o - ei(t, 'time', e[e.length - 2], 'pos')) / 2)),
            ...
            getLabelForIndex: function (t, e) {
              ...
              return (
                ...
                r.tooltipFormat
                  ? i.format(ni(n, o), r.tooltipFormat)
                  : 'string' == typeof o
                  ? o
                  : i.format(ni(n, o), r.displayFormats.datetime)
              )
            },
            tickFormatFunction: function (t, e, n, i) {
              var a = this._adapter,
                ...
                g = c ? h.major : h.minor,
                p = Yn([g.callback, g.userCallback, h.callback, h.userCallback])
              return p ? p(f, e, n) : f
            },
            ...
            getLabelCapacity: function (t) {
              var e = this,
                ...
                r = e.tickFormatFunction(t, 0, ri(e, [t], e._majorUnit), a),
                o = e._getLabelSize(r),
                s = Math.floor(
        ...
        function hi(t, e, n) {
          var i,
            ...
            r = a.fill
          if (
            (void 0 === r && (r = !!a.backgroundColor), !1 === r || null === r)
          )
            return !1
        ...
        function gi(t) {
          var e = t.fill,
            n = 'dataset'
          return !1 === e ? null : (isFinite(e) || (n = 'boundary'), di[n](t))
        }
        function pi(t) {
          return t && !t.skip
        }
              ...
              h && c
                ...
                : b &&
                  ...
                  (p
                    ...
                    : (mi(t, m, v, b, x), (b = x = 0), (m = []), (v = [])))
          mi(t, m, v, b, x), t.closePath(), (t.fillStyle = a), t.fill()
        }
        var bi = {
            id: 'filler',
              ...
              for (n = l.length - 1; n >= 0; --n)
                (e = l[n].$filler) &&
                  ...
                  o &&
                    ...
                    vi(u, r, o, a, s, i._loop),
                    V.canvas.unclipArea(u)))
            },
          },
          xi = V.rtl.getRtlAdapter,
          yi = V.noop,
          _i = V.valueOrDefault
        function ki(t, e) {
        ...
        var wi = G.extend({
              ...
              if (((a.font = r.string), u)) {
                ...
                ;(a.textAlign = 'left'),
                  ...
                  V.each(t.legendItems, function (t, e) {
                    var i = ki(n, o) + o / 2 + a.measureText(t.text).width
                    ;(0 === e ||
          ...
          draw: function () {
            ...
            if (e.display) {
              var d,
                h = xi(e.rtl, t.left, t.minSize.width),
                c = t.ctx,
              ...
              V.each(t.legendItems, function (e, i) {
                ...
                !(function (t, e, i) {
                  if (!(isNaN(m) || m <= 0)) {
                    c.save()
                    var o = _i(i.lineWidth, r.borderWidth)
                    if (
                      ((c.fillStyle = _i(i.fillStyle, a)),
                      (c.lineCap = _i(i.lineCap, r.borderCapStyle)),
                      (c.lineDashOffset = _i(
                        i.lineDashOffset,
                        r.borderDashOffset
                      )),
                      (c.lineJoin = _i(i.lineJoin, r.borderJoinStyle)),
                      (c.lineWidth = o),
                      (c.strokeStyle = _i(i.strokeStyle, a)),
                      c.setLineDash &&
                        c.setLineDash(_i(i.lineDash, r.borderDash)),
                      n && n.usePointStyle)
                    ) {
        ...
        function Mi(t, e) {
          var n = new wi({ ctx: t.ctx, options: e, chart: t })
            ...
            beforeUpdate: function (t) {
              ...
              e
                ? (V.mergeIf(e, z.global.legend),
                  n ? (ge.configure(t, n, e), (n.options = e)) : Mi(t, e))
        ...
        (Ke._adapters = Qe),
        (Ke.Animation = K),
        (Ke.animationService = Z),
        (Ke.controllers = Zt),
        (Ke.DatasetController = nt),
        (Ke.defaults = z),
        (Ke.Element = G),
        (Ke.elements = _t),
        (Ke.Interaction = ae),
        ...
        (Ke.Ticks = tn),
        (Ke.Tooltip = Ve),
        Ke.helpers.each(li, function (t, e) {
          Ke.scaleService.registerScaleType(e, t, t._defaults)
        }),
        Di))
          Di.hasOwnProperty(Oi) && Ke.plugins.register(Di[Oi])
        Ke.platform.initialize()
        var Li = Ke
        return (
          'undefined' != typeof window && (window.Chart = Ke),
          (Ke.Chart = Ke),
          (Ke.Legend = Di.legend._element),
          (Ke.Title = Di.title._element),
...
//# sourceMappingURL=4a3ea9cd-12162a16a571b2c94f09.js.map
