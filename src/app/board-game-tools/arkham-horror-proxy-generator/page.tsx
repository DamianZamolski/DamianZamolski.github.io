                ...
                <details>
                  ...
                  {status.warnings.failedDecks &&
                    status.warnings.failedDecks.length > 0 && (
                      <>
                        <small>
                          {`${status.warnings.failedDecks.length} deck(s) failed to fetch:`}
                        </small>
                        <ul>
                  ...
                  {status.warnings.failedCards &&
                    status.warnings.failedCards.length > 0 && (
                      <>
                        <small>
                          {`${status.warnings.failedCards.length} card(s) failed to fetch:`}
                        </small>
                        <ul>
                  ...
                  {status.warnings.skippedImages &&
                    status.warnings.skippedImages.length > 0 && (
                      <>
                        <small>
                          {`${status.warnings.skippedImages.length} image(s) skipped:`}
                        </small>
                        <ul>
